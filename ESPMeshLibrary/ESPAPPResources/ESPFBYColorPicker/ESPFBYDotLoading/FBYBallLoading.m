...
@interface FBYBallLoading ()<CAAnimationDelegate> {
...
-(void)initUI{
    ...
    self.backgroundColor = [UIColor colorWithRed:62/255.0 green:194/255.0 blue:252/255.0 alpha:1];
    ...
    _ballContainer.contentView.backgroundColor = [UIColor colorWithRed:62/255.0 green:194/255.0 blue:252/255.0 alpha:1];
    ...
    _ball1.backgroundColor = [UIColor whiteColor];
    ...
    _ball2.backgroundColor = [UIColor whiteColor];
    ...
    _ball3.backgroundColor = [UIColor whiteColor];
...
+(void)showInView:(UIView *)view{
    ...
    FBYBallLoading *loading = [[FBYBallLoading alloc] initWithFrame:view.bounds];
    [view addSubview:loading];
    [loading start];
}

+(void)hideInView:(UIView *)view{
    for (FBYBallLoading *loading in view.subviews) {
        if ([loading isKindOfClass:[FBYBallLoading class]]) {
            [loading stop];
